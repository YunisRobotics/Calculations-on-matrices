...
class Matrix:
    def __init__(self, matrix1_row, matrix1_column, matrix2_row, matrix2_column, user_input):
        ...
        if(matrix1_row == matrix2_row and matrix1_column == matrix2_column):
            print("Matrix addition/subtraction: True")  #This means that you can do both of them 
            print("Matrix multiplication: True")

        elif(matrix1_column == matrix2_row):
             print("Matrix addition/subtraction: False") #This means that you can do only multi and substraction
             print("Matrix multiplication: True")

        else:
            print("NOTE: You can't do any calculations on matrices")   #You can't do anything due to mismatched size

    def Addition(self):
        if self.i1 != self.i2 or self.j1 != self.j2:
            print("Addition isn't possible due to mismatched size")
            return None            
    ...
    def Subtraction(self):
        if self.i1 != self.i2 or self.j1 != self.j2:
            print("Substraction isn't possible due to mismatched size")
            return None            
    ...
    def Multiplication(self):
        if self.j1 != self.i2:
            print("Multiplication isn't possible due to mismatched size")
            return None            
